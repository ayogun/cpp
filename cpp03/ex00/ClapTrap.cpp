...
/*   Updated: 2023/03/15 20:35:19 by yogun            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

// Default constructor. It is private method.
...
void ClapTrap::takeDamage(unsigned int amount) {
  ...
  { // If the object has enough hit points to take the given amount of damage
    hitPoints_ -= amount; // Take the damage
    std::cout << "ClapTrap " << name_ << " takes " << amount << " points of damage!" << std::endl;
  } 
  
  else
  { // If the object doesn't have enough hit points to take the given amount of damage
